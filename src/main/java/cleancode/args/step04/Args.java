...
public class Args {
    ...
    private Map<Character, ArgumentMarshaler> booleanArgs = new HashMap<Character, ArgumentMarshaler>();  // step 04
    ...
    private void parseBooleanSchemaElement(char elementId) {
        // step 04
        // step 04
        booleanArgs.put(elementId, new BooleanArgumentMarshaler()); // step 04
    }
    ...
    private void setBooleanArg(char argChar, boolean value) {
        booleanArgs.get(argChar).setBoolean(value);    // step 04
    }
    ...
    public boolean getBoolean(char arg) {
        return booleanArgs.get(arg).getBoolean();   // step 04
    }
